...
insert into condition_category(order_id, conditon, category) values ('1', 'in process', '1');
insert into condition_category(order_id, conditon, category) values ('2', 'in process', '1');
insert into condition_category(order_id, conditon, category) values ('3', 'complete', '2');